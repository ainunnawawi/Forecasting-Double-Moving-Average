                            ...
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <br/>
                                            <h2 class="text-sm-center mt-2 mb-1">Selamat Datang di Halaman Perhitungan Forecasting Moving Average</h2>
                                        </div>
                                        <hr>
                                        <div class="location text-sm-center">
                                            <p>Moving Average atau dalam bahasa Indonesia disebut dengan Rata-rata Bergerak adalah salah satu metode peramalan bisnis yang sederhana dan sering digunakan untuk memperkirakan kondisi pada masa yang akan datang dengan menggunakan kumpulan data-data masa lalu (data-data historis).</p>
                                        </div>
                                        <hr>
                                        <div class="location text-sm-center">
